...
<svg xmlns="http://www.w3.org/2000/svg" width="467" height="195" viewBox="0 0 467 195" fill="none" role="img" aria-labelledby="descId">
        ...
        <desc id="descId">Total Stars Earned: 55985, Total Commits in 2023 : 55985, Total PRs: 597, Total Issues: 135, Contributed to (last year): 7</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 5.416444993576832;
      }
    }
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat  bold" x="219.01" y="12.5" data-testid="stars">56k</text>
    </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat  bold" x="219.01" y="12.5" data-testid="commits">183</text>
    </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat  bold" x="219.01" y="12.5" data-testid="prs">597</text>
    </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat  bold" x="219.01" y="12.5" data-testid="issues">135</text>
    </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat  bold" x="219.01" y="12.5" data-testid="contribs">7</text>
    </g>
  </g>
    </svg>
